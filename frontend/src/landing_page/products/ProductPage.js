...
function ProductPage() {
  return (
    <>
      ...
      />
       <RightSection 
        imageURL="media/images/kiteconnectimg.svg"
      ...
      />
       <LeftSection
        ...
        appStore=""
      />
      <p className="text-center fs-5 mb-5" style={{opacity:".85"}}>Want to know more about our technology stack? Check out the <a href="" style={{textDecoration:"none"}}>Zerodha.tech</a> blog.</p>
      <Universe />
    </>
  );
}
