    ...
    return ( 
        <div className='container mt-5'>
            <div className='row   mb-5 p-5'>
                <h1 className='fs-3 text-center' style={{opacity:".85"}}>We pioneered the discount broking model in India.<br/>
                Now, we are breaking ground with our technology.</h1>
            </div>
            <div className='row  border-top mt-5 p-5'>
                <div className='col-12 col-lg-6 p-5' style={{lineHeight:"2",fontSize:"1.1rem"}}>
                    <p>
                ...
                <div className='col-12 col-lg-6 p-5 ' style={{lineHeight:"1.9",fontSize:"1.1rem"}}>
                    <p>
